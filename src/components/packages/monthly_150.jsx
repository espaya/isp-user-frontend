export default function Monthly150() {
  return (
    <>
      <div className="price-block_one">
        ...
        >
          <div className="price-block_one-title_box">
            ...
            <h3 className="price-block_one-heading">Monthly</h3>
