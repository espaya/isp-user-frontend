      ...
      <div className="price-block_one">
        ...
        >
          <div className="price-block_one-title_box">
            <div className="price-block_one-title">TV + Internet+ Phone</div>
            <h3 className="price-block_one-heading">Special Offer</h3>
          ...
          <ul className="price-block_one-list">
            <li>
              ...
              10GB free data for all networks
            </li>
            <li>
              <i className="icon fa-solid fa-check fa-fw" />
              Turbo-Speed
